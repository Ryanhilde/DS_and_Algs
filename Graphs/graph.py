...
from queue_linked_list import QueuesLinked
...
print('Edge between vertex 1 and 3:', G.exist_edge(1, 3))
print('Degree:', G.indegree(2))

# ADJ Weighted Undirected Graph
G = Graph(4)
...
G.edges()
print('Edge between vertex 1 and 3:', G.exist_edge(1, 3))
print('Edge between vertex 1 and 2:', G.exist_edge(1, 2))
print("Indegree:", G.indegree(2))
print("Outdegree:", G.outdegree(2))
G.remove_edge(1, 2)
print('Edge between vertex 1 and 2:', G.exist_edge(1, 2))

# ADJ Weighted Directed Graph
G = Graph(4)
G.display_adjMat()
print('Vertices:', G.vertex_count())
G.insert_edge(0, 1, 26)
